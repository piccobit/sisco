...
func (e TagEdges) ServiceOrErr() ([]*Service, error) {
	if e.loadedTypes[0] {
...
// QueryService queries the "service" edge of the Tag entity.
func (t *Tag) QueryService() *ServiceQuery {
	return (&TagClient{config: t.config}).QueryService(t)
}
