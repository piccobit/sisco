...
ALTER TABLE "services" ADD COLUMN "available" boolean NOT NULL DEFAULT false, ADD COLUMN "heartbeat" timestamptz NOT NULL, ADD CONSTRAINT "services_areas_services" FOREIGN KEY ("area_services") REFERENCES "areas" ("id") ON DELETE SET NULL;
